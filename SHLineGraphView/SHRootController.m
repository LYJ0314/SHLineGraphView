...
- (void)viewDidLoad
{
   ...
   */
  _lineGraph.yAxisRange = @(98); // Y 轴的最大值
   ...
   */
  _lineGraph.yAxisSuffix = @"K"; // Y轴计算单量
  ...
  [_lineGraph addPlot:_plot1];  // 添加具体 折线图上 点 属性
...
#pragma mark 支持横屏 方法 http://www.tuicool.com/articles/vuEJz2y
